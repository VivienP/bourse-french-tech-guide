...
const ProjectExamples = () => {
  ...
  const projects = [{
    ...
    montantTotal: '43 000 €',
    fondsPropres: '30 000 €',
    summary: 'Développement d\'une application mobile basée sur l\'intelligence artificielle permettant de recommander aux utilisateurs les trajets les moins carbonés, intégrant les transports publics, la marche, le vélo et le covoiturage.',
    ...
    depenses: [
      ...
      'Algorithmes de pose estimation (dev. itératif) : 15 000 €',
      'Plateforme suivi thérapeutes : 10 000 €',
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 bg-gradient-to-r from-primary/20 to-primary/10 rounded-lg text-center border border-primary/20">
                ...
                <div className="p-4 bg-primary/10 rounded-lg text-center">
                  ...
                  <p className="text-xl font-bold text-yellow-600">{project.subvention}</p>
                </div>
                <div className="p-4 bg-gray-50 rounded-lg text-center">
                  <p className="text-sm font-medium text-gray-600">Fonds propres</p>
                  <p className="text-xl font-bold text-gray-700">{project.fondsPropres}</p>
                </div>
              </div>
