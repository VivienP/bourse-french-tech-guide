...
const CTASection2 = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      Cal("init", "bft2", {origin:"https://app.cal.com"});
      Cal.ns.bft2("inline", {
        elementOrSelector:"#my-cal-inline-bft2",
        config: {"layout":"month_view","theme":"light"},
        calLink: "vivienperrelle/bft",
      });
      Cal.ns.bft2("ui", {"theme":"light","cssVarsPerTheme":{"light":{"cal-brand":"#F8D164"},"dark":{"cal-brand":"#FFFFFF"}},"hideEventTypeDetails":true,"layout":"month_view"});
    `;
  ...
  return (
    <section id="cta2" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Background elements */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="w-full h-[600px] rounded-lg overflow-hidden -mt-4">
            <div style={{width:'100%',height:'100%',overflow:'scroll'}} id="my-cal-inline-bft2"></div>
          </div>
        </div>
      </div>
    </section>
