...
const ExpensesSection = () => {
  ...
  const internalExpenses = [
    ...
    { title: 'Frais généraux forfaitaires (20% des salaires)', description: "Prise en compte forfaitaire des frais de fonctionnement à hauteur de 20% des salaires déclarés sur le projet." }
  ];

  return (
    <section id="depenses" className="py-20 px-4 sm:px-6 lg:px-8 bg-card">
