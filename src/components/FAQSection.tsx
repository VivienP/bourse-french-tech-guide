...
const FAQSection = () => {
  const faqData = [
    ...
    { question: "Tous les secteurs sont-ils éligibles ?", answer: "Oui, à condition que le projet soit innovant et respecte les critères. En 2025, les projets software, notamment en IA, dominent les financements." },
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {faqData.map((faq, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="bg-card rounded-2xl border border-border px-2 shadow-warm">
