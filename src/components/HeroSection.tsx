      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in [animation-delay:200ms] opacity-0 [animation-fill-mode:forwards]">
            Subvention publique non remboursable jusqu'à <span className="bg-gradient-to-r from-[#E6B800] to-[#E6B800] bg-clip-text text-transparent font-semibold">50 000 €</span> pour soutenir 
