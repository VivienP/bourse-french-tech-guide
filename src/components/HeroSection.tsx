      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed transition-opacity duration-500 delay-100">
            Subvention publique non remboursable jusqu'à <span className="text-primary font-semibold">30 000 €</span> pour soutenir 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              ...
              className="bg-primary hover:bg-primary/90 text-primary-foreground text-lg px-8 py-3 transition-all duration-200 rounded-lg"
            >
            ...
            <Button
              ...
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground text-lg px-8 py-3 transition-all duration-200 rounded-lg"
            >
              Prendre rendez-vous
            </Button>
          </div>
