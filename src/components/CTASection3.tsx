...
const CTASection3 = () => {
  ...
  return (
    <section id="cta3" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      {/* Background elements */}
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <div className="w-full h-[600px] rounded-lg overflow-hidden -mt-4">
            <div style={{width:'100%',height:'100%',overflow:'scroll'}} id="my-cal-inline-bft3"></div>
          </div>
        </div>
      </div>
    </section>
