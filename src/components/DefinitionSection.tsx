...
const DefinitionSection = () => {
  ...
  const { ref: contentRef, isVisible: contentVisible } = useScrollAnimation(0.1, 200);
  ...
  return (
    <section id="definition" className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div 
          ref={contentRef}
          className={`prose prose-lg max-w-none text-gray-600 leading-relaxed transition-all duration-700 ${
            contentVisible 
              ? 'opacity-100 translate-y-0' 
              : 'opacity-0 translate-y-8'
          }`}
