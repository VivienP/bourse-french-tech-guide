...
const FranceMap = () => {
  const regionDelegations = [{
    ...
    delegations: [{
      ...
      name: 'Délégation Bourg-en-Bresse',
      difficulty: 'Accessible'
    }, {
      name: 'Délégation Saint-Etienne',
      difficulty: 'Modéré'
    }, {
      name: 'Délégation Valence',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale Clermont-Ferrand',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale Grenoble',
      difficulty: 'Compétitif'
    }, {
      name: 'Direction régionale Lyon',
      difficulty: 'Compétitif'
    }]
  }, {
    region: 'Occitanie',
    delegations: [{
      ...
      name: 'Direction régionale Montpellier',
      difficulty: 'Modéré'
    }, {
      name: 'Direction régionale Toulouse',
      difficulty: 'Modéré'
    }, {
    ...
    region: 'Outre-mer',
    delegations: [{
      name: 'Direction régionale Guadeloupe',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale Martinique',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale Guyane',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale La Réunion',
      difficulty: 'Accessible'
    }, {
      name: 'Direction régionale Mayotte',
      difficulty: 'Accessible'
    }, {
  ...
  return <div className="relative">
      <div className="bg-white p-6 rounded-lg shadow-lg border-2 border-primary/20">
        <h3 className="text-lg font-semibold text-center mb-6">Délégations par région et niveau de difficulté (à titre indicatif)</h3>
        
        <div className="space-y-2">
          {regionDelegations.map((regionData, index) => <Collapsible key={index}>
              <Card className={`border-l-4 ${getRegionColor(regionData.delegations)}`}>
                ...
                <CollapsibleContent>
                  <CardContent className="pt-0 pb-3">
                    <div className="space-y-2">
                      {regionData.delegations.map((delegation, delIndex) => <div key={delIndex} className="flex items-center justify-between py-1 px-2 rounded bg-gray-50">
